  ...
  return (
    <div className="hairline-b overflow-hidden bg-paper">
      <div className="mx-auto flex max-w-[1360px] items-stretch">
        <span className="flex items-center border-r border-rule bg-ink px-3 font-sans text-[10px] font-semibold uppercase tracking-widest text-paper">
          Live Markets
        </span>
...
function TrendingTags() {
  return (
    <div className="hairline-b bg-paper">
      <div className="mx-auto flex max-w-[1360px] items-center gap-3 overflow-x-auto whitespace-nowrap px-4 py-2 sm:px-6">
        <span className="inline-flex items-center gap-2 font-sans text-[10px] font-semibold uppercase tracking-widest text-breaking">
          <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-breaking" />
          Breaking
        </span>
        ...
        {TRENDING.map((t) => (
          <a
            key={t}
            href={`#${t}`}
            className="font-sans text-[12px] tracking-wide text-ink-soft hover:text-link"
          >
            {t}
          </a>
        ))}
...
function BarChart() {
  const rows = [
    { y: "2019", value: 42, alloc: "Equities-heavy, momentum-led" },
    { y: "2020", value: 58, alloc: "Liquidity surge; passive dominance" },
    { y: "2021", value: 71, alloc: "Retail speculation peaks" },
    { y: "2022", value: 46, alloc: "Duration reset; multiple compression" },
    { y: "2023", value: 34, alloc: "Cash yields > risk premia" },
    { y: "2024", value: 28, alloc: "Return to fundamentals begins" },
    { y: "2025", value: 22, alloc: "Research-led rotation accelerates" },
  ];
  const max = 71;
  return (
    <figure className="my-10 border border-rule bg-paper p-6" data-reveal>
      <figcaption className="mb-6">
        ...
        <p className="mt-1 font-serif text-sm text-ink-soft">
          ...
          Source: Investor's Chronicle analysis of EPFR &amp; Morningstar data.
        </p>
      </figcaption>
  ...
  return (
    <div className="my-10 flex items-start gap-4 border border-rule p-6" data-reveal>
      ...
      <p className="font-serif text-[15px] leading-relaxed text-ink-soft">
        This report is part of a continuing Investor's Chronicle series on the
        institutionalisation of private capital. Data cited has been independently
        verified by our research desk in London and Mumbai.
      </p>
    </div>
  );
}
    ...
    >
      ...
      <section id="sec-numbers">
        ...
        <p className="mt-4 text-[17px] leading-[1.8]">
          The shift can be measured. Analysis conducted for the Chronicle by three
          independent data providers shows a consistent pattern across the last eight
          quarters: flows into strategies with no explicit fundamental screen have
      ...
      <section id="sec-desk">
        ...
        <p className="mt-4 text-[17px] leading-[1.8]">
          ...
          investment firm that has, in relative silence, become one of the most
          consistently cited allocators in the trade. Founded in 1998 by two former
          fixed-income traders, the firm has quietly compounded client capital at{" "}
          <strong className="whitespace-nowrap">11.6% net</strong> over its five-year
          window, with a maximum drawdown of less than nine per cent.
        </p>
        <p className="mt-4 text-[17px] leading-[1.8]">
          "There is no proprietary alchemy here," Alistair Warde, the firm's chief
          investment officer, told the Chronicle in an interview at the firm's Cornhill
          offices. "We write things down. We argue. We wait. And, on the rare occasions
          the market offers us a genuine mispricing, we buy — and we hold long enough for
          the thesis to actually happen."
        </p>
      ...
      <div className="mx-auto max-w-[1360px] px-4 sm:px-6">
        <div className="mx-auto max-w-[820px] hairline-thick pt-6">
          ...
          <p className="mt-5 font-serif text-lg leading-relaxed text-ink-soft">
            Over the past quarter, Chronicle reporters were granted rare access to the
            people, processes and pages of research that sit behind one of the industry's
            quietest track records. What they found was not a formula — but a temperament.
          </p>
        </div>
        ...
        <figure className="mx-auto mt-10 max-w-[1100px]" data-reveal>
          ...
          <figcaption className="mt-3 font-sans text-[12px] italic text-ink-soft">
            The firm's Cornhill headquarters, City of London. Its research desk has
            grown from four to thirty-one analysts since 2013.
          </figcaption>
        </figure>
        ...
        <div className="mx-auto mt-20 grid max-w-[1100px] gap-10 lg:grid-cols-5" data-reveal>
          <div className="lg:col-span-3">
            ...
            <p className="mt-2 font-serif text-sm text-ink-soft">
              Composite house view as of the most recent quarterly committee.
            </p>
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-2 font-serif text-sm text-ink-soft">
              Net of fees. Benchmark: 60/40 global blended index.
            </p>
            ...
            <p className="mt-3 font-serif text-[12px] italic text-ink-soft">
              Past performance is not a guarantee of future results. Figures independently
        ...
        {/* Analyst opinion */}
        <div id="technology" className="mx-auto mt-16 grid max-w-[1100px] gap-8 md:grid-cols-2" data-reveal>
          <div className="border border-rule p-6">
            <p className="eyebrow">Analyst opinion · Rates</p>
            <blockquote className="mt-3 font-display text-2xl leading-tight">
              “The most under-priced asset in 2025 is the discipline required to hold
              cash while everyone else buys narrative.”
            </blockquote>
            <p className="mt-4 font-sans text-[12px] uppercase tracking-widest text-ink-soft">
              — Priya Ramanathan, Head of Fixed Income Research
            </p>
          </div>
          <div className="border border-rule p-6">
            <p className="eyebrow">Analyst opinion · Equities</p>
            <blockquote className="mt-3 font-display text-2xl leading-tight">
              “A portfolio is not a list of names. It is a written argument, priced daily
              by a market that doesn't much care whether you were right yesterday.”
            </blockquote>
            <p className="mt-4 font-sans text-[12px] uppercase tracking-widest text-ink-soft">
              — Marcus Ashcroft, Chairman &amp; Founding Partner
            </p>
          </div>
        </div>

        {/* Outlook */}
        <div id="editorial" className="mx-auto mt-20 max-w-[820px] font-serif" data-reveal>
          <p className="eyebrow">Outlook</p>
          <h4 className="mt-2 font-display text-3xl leading-tight sm:text-4xl">
            The next twelve months, according to the firm
          </h4>
          <p className="mt-4 text-[17px] leading-[1.8]">
            The Chronicle asked the investment committee for its base-case reading of the
            coming year. The answer, in a single sentence: <em>the return of dispersion.</em>{" "}
            Winners and losers will once again be separated by earnings, not by narratives.
            "For the first time in a decade," Warde said, closing our final interview, "the
            job is interesting again."
          </p>
        </div>
      </div>
    </section>
...
function ConsultationForm() {
  ...
  function validate() {
    ...
    if (form.phone && !/^[+\d\s()-]{7,}$/.test(form.phone)) e.phone = "Please enter a valid phone.";
  ...
  return (
    <form onSubmit={onSubmit} noValidate className="border border-rule bg-paper p-6 sm:p-10">
      <div className="grid gap-x-8 gap-y-6 sm:grid-cols-2">
        ...
        <div>
          <label htmlFor="phone" className="eyebrow">Telephone</label>
          <input
            id="phone"
            type="tel"
            className={field}
      ...
      <div className="mt-8 flex flex-col-reverse items-start justify-between gap-4 border-t border-rule pt-6 sm:flex-row sm:items-center">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 border border-ink bg-ink px-6 py-3 font-sans text-[12px] uppercase tracking-widest text-paper transition-colors hover:bg-paper hover:text-ink disabled:opacity-60"
        >
          {status === "loading" ? (
            <>
      ...
      <div className="mx-auto max-w-[1360px] px-4 sm:px-6">
        <div className="mx-auto max-w-[820px] hairline-thick pt-6" data-reveal>
          ...
          <p className="mt-5 font-serif text-lg leading-relaxed text-ink-soft">
            ...
            with the material directly. The Chronicle has arranged, on your behalf, three
